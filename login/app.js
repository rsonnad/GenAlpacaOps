...
const redirectUrl = urlParams.get('redirect') || '/GenAlpacaOps/spaces/admin/';
...
googleSignInBtn.addEventListener('click', async () => {
  ...
  try {
    ...
    const loginRedirect = window.location.origin + '/GenAlpacaOps/login/?redirect=' + encodeURIComponent(redirectUrl);
