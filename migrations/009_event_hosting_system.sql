...
('Default Event Agreement', '# Alpaca Playhouse Event RENTAL AGREEMENT

**Last Updated: {{agreement_date}}**

---

This Rental Agreement (hereinafter, "Agreement") is made by and between the Revocable Trust of Subhash Sonnad (dba Alpaca Playhouse), (hereinafter, "Company"), and the person(s)/company/organization renting the venue (hereinafter, "Client" or "Renter"), **{{client_name}}**.
...
Company agrees to rent to Client the following spaces at 160 Still Forest Drive (aka the Austin Alpaca Playhouse):
...
Client agrees that any photography of their event at the Alpaca Playhouse will not be publicly posted without permission. The name "Alpaca Playhouse" will only be used in describing the location and not as a host of the event.
...
| Date:                    | Date:                                          |
|                          | Administrator Austin Alpaca Playhouse          |
| Address                  | 160 Still Forest DR                            |
| City, State, Zip Code    | Cedar Creek TX 78612                           |
...
3. **Address Privacy:** Client agrees to NOT post the address of the venue in any distributed materials including texts, emails, social media postings or printed materials. Instead a link to alpacaplayhouse.com/visiting web page will be provided. $100 fee if address is posted.

4. **Marketing Materials:** Client will send links to all marketing materials to +14242341750 on WhatsApp or to specified WhatsApp group or alpacaplayhouse@gmail.com
